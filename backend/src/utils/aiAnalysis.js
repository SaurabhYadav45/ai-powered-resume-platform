...
const aiAnalysis = {
  ...
  // // 3. Build Resume Content (Updated Structure)
  // buildResumeContent: async (userData) => {
  //   console.log("--- [AI Service] Starting Resume Content Generation ---");
  ...
  //     **Instructions:**
  //     1. **Header:** Use the exact Name, Email, Phone, GitHub, LinkedIn provided. Do not invent them.
  //     2. **Summary:** Write a concise 3-line professional summary based on the user's input.
  //     3. **Experience & Projects:** Convert raw descriptions into 2-3 punchy bullet points each using strong action verbs (e.g., "Developed", "Optimized", "Led"). Quantify achievements where possible.
  //     4. **Skills:** Clean up the skills list into a professional format.
  //     5. **Education:** Keep the details exactly as provided.
  //     6. **Achievements:** Polish into impressive one-liners.
  ...
  //       ],
  //       "projects": [
  //         { "title": "String", "techStack": "String", "descriptionPoints": ["String", "String"] }
  //       ],
  //       "achievements": ["String", "String"]
  //     }
  //   `;
  ...
  //   } catch (error) {
  //     console.error("--- [AI Service] Resume Builder Error: ---", error);
  //     throw new Error("Failed to build resume content.");
  //   }
  // }
};
